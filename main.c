...
//  Read_DataDHT();
  draw_pic_8bit(20, 20, ICON_TEMP, COLOR_RED, 2);
  draw_string(50, 20, COLOR_GOLD, 1, "TEMPERATURE");
  draw_pic_8bit(20, 40, ICON_HUM, COLOR_BLUE, 2);
  draw_string(50, 40, COLOR_GOLD, 1, "HUMIDITY");
  /* USER CODE END 2 */
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
		 ...
		 RTC_ReadTime(&datetime);
		  ...
		  draw_pic_8bit(30, 100, ICON_CLOCK, COLOR_SKYBLUE, 2);
...
//		  //để sprintf ở đây để convert, lệnh in lên LCD nằm trong thư viện của LCD
		  if(date_temp != date_present)
		      ...
		      draw_pic_8bit(30, 120, ICON_CALENDAR, COLOR_SKYBLUE, 2);
		  	...
		  	if(datetime.hour >=6 && datetime.hour <=18){
                draw_pic_16bit(100, 110, SUN, COLOR_YELLOW, 2);}
                else {
                	draw_pic_16bit(100, 110, MOON, COLOR_YELLOW, 2);
                }

		  	draw_string(30, 150, COLOR_DARKGREEN, 1, "PRJ CLOCK WITH TEMP & HUMIT");
		  		  	  Read_DataDHT();
...
//	      draw_string(20, 40, COLOR_GOLD, 1, "HUMIDITY");
	      ...
	      draw_string(100, 20, COLOR_BLUE, 1, temperature_string);
		  draw_string(100, 40, COLOR_BLUE, 1, humidity_string);
//	  	  DHT_GetData(&dht11);
//	  	  Read_DataDHT();
  }
  /* USER CODE END 3 */
